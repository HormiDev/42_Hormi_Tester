...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/05/20 01:36:16 by ide-dieg          #+#    #+#             */
/*   Updated: 2025/05/20 01:42:14 by ide-dieg         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void test_memmove(int d, int i, int e)
{
	char		*original;
	char		*libft;
	int 		ok = 0;
	...
	{
		fflush(stdout);
		exec_function(&original, arg[count].dst, arg[count].src, arg[count].n, &memmove);
		fflush(stdout);
		exec_function(&libft, arg[count].dst, arg[count].src, arg[count].n, &ft_memmove);
...
int main(int argc, char **argv)
{
	...
	printf("%s%s%-16s%s ", COLOR_BOLD, COLOR_CYAN, "ft_memmove:", COLOR_RESET);
	test_memmove(d, i, e);
	printf("\n");
	while (count < argc)
	{
